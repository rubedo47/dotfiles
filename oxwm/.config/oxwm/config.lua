...
oxwm.rule.add({ class = "St", master = true })
...
oxwm.bar.set_scheme_selected(colors.cyan, colors.bg, colors.green)
...
oxwm.key.bind({ modkey }, "Space", oxwm.spawn({ "sh", "-c", "st -n otter -g 60x20 -e otter-launcher" }))
oxwm.rule.add({ instance = "otter", floating = true })
...
-- Layout management
oxwm.key.bind({ modkey }, "C", oxwm.layout.set("normie"))
oxwm.key.bind({ modkey }, "F", oxwm.layout.set("tiling"))
...
-- Custom function to move focused window to the master slot
